...
[![Version](https://img.shields.io/badge/버전-2.4.4-orange)](client/package.json)
...
**프로필 > 메시지 개인정보**에서 이 기기의 모든 채팅에 추가 비밀번호를 사용할 수 있습니다. 본문은 추가로 암호화된 뒤 **불교식 텍스트, 무작위 중국어, 주역 기호, 한글, 이집트 상형문자, 설형문자, 핵심 가치 텍스트, 영숫자** 중 하나로 표시됩니다.

- 양쪽이 각자의 기기에 같은 추가 비밀번호를 설정해야 하며, 비밀번호는 자동 동기화되지 않습니다.
...
- 텍스트 모양은 추가 로컬 개인정보 계층이며 **종단간 암호화를 대체하지 않습니다**.
