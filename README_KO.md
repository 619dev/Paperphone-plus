...
| 👥 그룹 채팅 | 최대 2000명, 평문 메시지 (암호화 없음), 방해 금지 모드, 멤버 관리 |
...
| `VAPID_SUBJECT` | VAPID 연락처 이메일 (선택 사항) | `mailto:admin@paperphone.app` |
...
Google Mobile Services가 없는 Android 기기 (Huawei, Xiaomi, OPPO, vivo 등)의 경우, PaperPhone은 [ntfy](https://ntfy.sh)를 통한 푸시 알림을 지원합니다.
...
2. PaperPhone 설정을 열고 "ntfy 푸시" 카드를 찾습니다
