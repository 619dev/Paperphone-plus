export const zh: Record<string, string> = {
  ...
  'chat.attach_more': '更多',
  'chat.file': '文件',
  'chat.batch_download': '批量下载',
  'chat.batch_download_selected': '已选择 {count}/{max}',
  'chat.batch_download_limit': '一次最多选择 20 个文件。',
  'chat.batch_downloading': '正在下载 {completed}/{total}',
  'chat.batch_download_complete': '所选文件已下载完成。',
  'chat.batch_download_partial': '下载完成，其中 {count} 个文件失败。',
  'chat.recording': '正在录音...',
