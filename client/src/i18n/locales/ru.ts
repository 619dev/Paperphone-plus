export const ru: Record<string, string> = {
  ...
  "chat.presentation_title": "Дополнительное локальное шифрование",
  'profile.message_privacy': 'Конфиденциальность сообщений',
  'profile.message_privacy_desc': 'Эти настройки применяются ко всем чатам на этом устройстве. Исходные метаданные протокола скрываются выбранным оформлением текста.',
