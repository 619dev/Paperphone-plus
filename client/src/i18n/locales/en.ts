export const en: Record<string, string> = {
  ...
  'chat.file': 'File',
  'chat.batch_download': 'Batch download',
  'chat.batch_download_selected': 'Selected {count}/{max}',
  'chat.batch_download_limit': 'You can select up to 20 files at once.',
  'chat.batch_downloading': 'Downloading {completed}/{total}',
  'chat.batch_download_complete': 'Selected files downloaded.',
  'chat.batch_download_partial': 'Download finished with {count} failed files.',
