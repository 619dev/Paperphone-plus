export const en: Record<string, string> = {
  ...
  'chat.presentation_title': 'Extra local message encryption',
  'profile.message_privacy': 'Message privacy',
  'profile.message_privacy_desc': 'These settings apply globally to every chat on this device. The original protocol metadata is hidden by the selected text appearance.',
