...
В разделе **Профиль > Конфиденциальность сообщений** можно включить дополнительный пароль для всех чатов на этом устройстве. После шифрования текст отображается как **буддийский текст, случайные китайские иероглифы, символы Ицзина, хангыль, египетские иероглифы, клинопись, текст основных ценностей или буквы и цифры**.

- Обе стороны должны задать одинаковый пароль; он не синхронизируется автоматически.
...
- Оформление текста — дополнительный локальный уровень конфиденциальности; оно **не заменяет сквозное шифрование**.
